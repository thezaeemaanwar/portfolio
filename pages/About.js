...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="text-lg w-11/12 md:w-3/4 bg-opacity-5 bg-accent-text px-10 py-24 sm:px-24 lg:px-48 my-5 rounded-lg shadow-lg mb-10">
        <div className="text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-primary to-orange filter drop-shadow-lg pb-2 px-6 border-primary border-b-2">
          About Me
        </div>
